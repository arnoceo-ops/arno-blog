(function () {
  ...
  var CSS = [
    ...
    '  font-family:"Bebas Neue",sans-serif;font-size:14px;letter-spacing:1px;color:#fff;',
    '  flex-shrink:0;',
    '}',
    '#arnobot-header-text{}',
    ...
    '.ab-msg-text.user{font-size:17px;line-height:1.4;color:rgb(51,51,51);font-family:"Bebas Neue",sans-serif;letter-spacing:0.5px;}',
    ...
    '.ab-openers-label{font-size:9px;letter-spacing:4px;text-transform:uppercase;color:#ccc;display:block;margin-bottom:12px;}',
    ...
    '#arnobot-hint{font-size:9px;letter-spacing:2px;color:#ddd;text-transform:uppercase;margin-top:6px;text-align:center;}',
