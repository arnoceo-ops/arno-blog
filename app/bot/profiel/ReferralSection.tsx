  ...
  return (
    <div style={wrapStyle}>
      ...
      <p style={{ fontFamily: "'Space Mono', monospace", fontSize: 15, lineHeight: 1.9, color: '#9ca3af', marginBottom: 24 }}>
        Deel deze link. Nieuwe gebruikers krijgen de eerste maand 50% korting. <strong style={{ color: '#f1f5f9' }}>Jij ook op je volgende maand.</strong> Bij 25 betalende referrals word je lid van de ArnoBot Ambassadors Club. Bij 50 betalende referrals krijg je een Lifetime Subscription op ArnoBot. Go, Go Gadget. Bij 100 betalende referrals krijg je een aanbieding voor deelname in de ArnoBot Venture 🚀
      </p>
