      ...
      <section className="subscribe-section">
        ...
        <div className="subscribe-text-col" style={{alignItems:'center', padding:'80px 60px'}}>
          <div style={{display:'flex', flexDirection:'column', alignItems:'center', gap:'20px', textAlign:'center'}}>
            <div style={{border:'2px solid transparent', padding:'10px 28px', fontFamily:"'Bebas Neue', sans-serif", fontSize:'24px', letterSpacing:'4px', visibility:'hidden'}}>4 maanden gratis.</div>
