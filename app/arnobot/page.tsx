    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ab-pricing-btn {
          ...
          width: 100%; max-width: 320px; transition: background 0.2s;
          margin-top: 8px;
        }
      ...
      <nav className="site-nav">
        <div className="nav-links">
          ...
          <Link href="/arnobot" className="nav-active">ARNOBOT</Link>
      ...
      <section className="ab-hero">
        ...
        <div className="ab-hero-right">
          ...
          <p className="ab-hero-sub">Één advies kan je<br />tonnen opleveren.<br /><span style={{color:'#EE7700'}}>€97 per maand.</span></p>
        ...
        <div className="ab-features-right">
          <div className="ab-feature-item">
            ...
            <span className="ab-feature-text">
              ...
              <small>Geen limiet. Geen wachttijd.</small>
            </span>
          </div>
          <div className="ab-feature-item">
            <span className="ab-feature-arrow">→</span>
            <span className="ab-feature-text">
              Sessiehistorie
              <small>Al je gesprekken bewaard en doorzoekbaar.</small>
            </span>
          </div>
          <div className="ab-feature-item">
            <span className="ab-feature-arrow">→</span>
            <span className="ab-feature-text">
              PDF export
              <small>Exporteer elk gesprek als document.</small>
            </span>
          </div>
          <div className="ab-feature-item">
            <span className="ab-feature-arrow">→</span>
            <span className="ab-feature-text">
              19 jaar blogarchief
              <small>Gefundeerd op 369.000+ woorden aan sales-inzichten.</small>
            </span>
          </div>
          <div className="ab-feature-item">
            <span className="ab-feature-arrow">→</span>
            <span className="ab-feature-text">
              Direct antwoord
              <small>Geen corporate taal. Geen omwegen. Gewoon Arno.</small>
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="ab-pricing">
        <div className="ab-pricing-card">
          ...
          <a href="https://royaldutchsales.com/arnobot?plan=monthly" className="ab-pricing-btn dark">START NU →</a>
        </div>
        <div className="ab-pricing-card featured">
          ...
          <a href="https://royaldutchsales.com/arnobot?plan=yearly" className="ab-pricing-btn">START NU →</a>
        </div>
      </section>

      {/* COMING SOON: ARNO LIVE */}
