...
const s = {
  ...
  textarea: { width: '100%', backgroundColor: 'transparent', border: 'none', borderBottom: '1px solid #1e1e1e', color: '#f0ede6', fontSize: '14px', padding: '12px 0', resize: 'none' as const, outline: 'none', fontFamily: 'var(--font-space-mono, monospace)', lineHeight: 1.7, minHeight: '90px', boxSizing: 'border-box' as const },
  ...
  groupLabel: { fontSize: '11px', fontWeight: 700, letterSpacing: '4px', color: '#EE7700', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '12px' } as React.CSSProperties,
  ...
  return (
    <main style={s.page}>
      ...
      <div style={s.pageHeader}>
        <p style={s.pageTag}>05 — 06</p>
        <h1 style={s.pageTitle}>UITVOERING</h1>
      </div>
