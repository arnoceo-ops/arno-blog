    ...
    const bodyHtml = uitdaging
      ? `
        <div style="font-family: 'Courier New', monospace; background: #111827; color: #f1f5f9; padding: 40px; max-width: 560px; margin: 0 auto;">
          <p style="color: #f59e0b; font-size: 12px; letter-spacing: 4px; margin-bottom: 32px;">ARNOBOT — ROYAL DUTCH SALES</p>
          <h1 style="font-size: 28px; font-weight: 700; margin-bottom: 24px; line-height: 1.3;">Je uitdaging staat nog open.</h1>
          <div style="border-left: 3px solid #f59e0b; padding: 16px 20px; background: #1f2937; margin-bottom: 32px;">
            <p style="font-size: 13px; letter-spacing: 2px; color: #f59e0b; margin-bottom: 8px;">UIT: ${gesprekTitel || 'JE LAATSTE GESPREK'}</p>
            <p style="font-size: 15px; line-height: 1.8; color: #f1f5f9;">${uitdaging}</p>
          </div>
          <p style="font-size: 14px; color: #9ca3af; line-height: 1.8; margin-bottom: 32px;">Heb je dit gedaan? Of zit er nog iets in de weg? Kom terug en ga het gesprek aan.</p>
          <a href="https://arno.bot/bot" style="display: inline-block; background: #f59e0b; color: #111827; font-weight: 700; font-size: 14px; letter-spacing: 3px; padding: 14px 28px; text-decoration: none;">OPEN DE BOT →</a>
        </div>
      `
      : `
        <div style="font-family: 'Courier New', monospace; background: #111827; color: #f1f5f9; padding: 40px; max-width: 560px; margin: 0 auto;">
          ...
          <p style="font-size: 14px; color: #9ca3af; line-height: 1.8; margin-bottom: 32px;">Arno staat klaar. Wat houdt je bezig? Eén vraag is genoeg om weer scherp te worden.</p>
          <a href="https://arno.bot/bot" style="display: inline-block; background: #f59e0b; color: #111827; font-weight: 700; font-size: 14px; letter-spacing: 3px; padding: 14px 28px; text-decoration: none;">OPEN DE BOT →</a>
        </div>
      `
